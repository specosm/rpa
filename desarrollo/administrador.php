...
<div class="card text-center" style="width: 100%;">
    <div class="card-header ColorTab black-text">
        Administrador de procesos disponibles
    </div>
    <div class="card-body ">
                ...
                <th colspan="2">Opciones
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a onclick="crearProcess_robotClass()" >Crear Proceso</a>
                            <div class="dropdown-divider"></div>
                            <a onclick="asignar_robotClass()" >Asignar Proceso</a>
                            <div class="dropdown-divider"></div>
                            <a onclick="install_robotClass()" >Instalar Proceso</a>
                        </div>
                    </div>
...
<script type="application/javascript">
    function crearProcess_robotClass () {
        $.post("./desarrollo/crear.php", function(htmlexterno){
            $("#contenido").html(htmlexterno);
        });
    }

    function asignar_robotClass () {
        $.post("./desarrollo/asignacion.php", function(htmlexterno){
            $("#contenido").html(htmlexterno);
        });
    }

    function install_robotClass () {
        $.post("./desarrollo/instalar.php", function(htmlexterno){
            $("#contenido").html(htmlexterno);
        });
    }
