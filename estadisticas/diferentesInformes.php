...
if ((isset($_POST['id'])) and ($_POST['id'] != "")) {
    $id = $_POST['id'];
    $_SESSION["backInformesDetalle"]=$id;
}
    ...
    <div class="card-body process">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th>Informe No Contable</th>
                <th>Informe Tiempo</th>
            </tr>
            </thead>
    ...
    <div class="row">
        <div  class="col-sm-2 col-lg-2 col-md-2 col-xl-2">
            <div class="card-link text-muted black-text">
                <input onclick="procesoInforme()" class="btn btn-outline-default btn-rounded waves-effect" type="button"  value="Volver">
            </div>
        </div>
    </div>
</div>
...
<script type="application/javascript">
    ...
    $('#pagination').on('click', 'a', function (e) {
        ...
        let data = {id:<?php echo $id; ?>,modo: 'paginarInformes', page: page, per_page: 4};
